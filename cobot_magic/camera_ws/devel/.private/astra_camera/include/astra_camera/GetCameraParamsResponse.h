  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::astra_camera::GetCameraParamsResponse_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.l_intr_p.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.l_intr_p[i]);
    }
    if (v.l_intr_p.empty() || true)
      s << "]";
    ...
    for (size_t i = 0; i < v.r_intr_p.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.r_intr_p[i]);
    }
    if (v.r_intr_p.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.r2l_r.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.r2l_r[i]);
    }
    if (v.r2l_r.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.r2l_t.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.r2l_t[i]);
    }
    if (v.r2l_t.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.l_k.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.l_k[i]);
    }
    if (v.l_k.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.r_k.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.r_k[i]);
    }
    if (v.r_k.empty() || true)
      s << "]";
    if (true || !indent.empty())
